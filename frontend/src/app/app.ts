...
export class App {
  ...
  constructor() {
    ...
    this.router.events.pipe(
      ...
      if (url.includes('files')) this.pageTitle.set('Хранилище файлов');
      else if (url.includes('notes')) this.pageTitle.set('Мои Заметки');
      else if (url.includes('admin')) this.pageTitle.set('Панель управления');
      else this.pageTitle.set('Буфер обмена');
    });
  }
